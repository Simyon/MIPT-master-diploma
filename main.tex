...
\input{diploma/1_introduction.tex}

\chapter{Литературный обзор} 

\input{diploma/2_literature.tex}

\chapter{Постановка задачи}

\input{diploma/3_formulation.tex}

\chapter{Эксперименты}

\input{diploma/4_experiments.tex}

\chapter{Обсуждение результатов}

\input{diploma/5_discussion.tex}

\chapter{Заключение}

\input{diploma/6_conclusion.tex}
